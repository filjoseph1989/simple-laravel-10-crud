...
@section('content')
    ...
    <div class="flex flex-row justify-center">
        <div class="bg-zinc-800 w-1/2 flex justify-center">
            <div class="rounded-md border bg-white w-full">
                <div class="bg-white rounded-lg shadow-lg">
                    <div class="flex flex-col p-4">
                        ...
                        <div>
                            ...
                            <i><a href="http://{{ $store->user_id }}">Owner</a> | {{ $store->created_at->format("M d, Y") }}{{ $store->id }}</i>
